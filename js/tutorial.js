...
const TUTORIAL_DATA = {
  ...
  camp: {
    ...
    paragraphs: [
      ...
      "„👥 Drużyna” pokazuje Twoich towarzyszy (maks. 3, zawsze innej klasy niż Twoja). W dwóch losowych miejscach w mieście Aetherion czekają potencjalni rekruci — każdy chce zobaczyć, że potrafisz walczyć, więc pokaże pasek postępu do konkretnej liczby pokonanych przeciwników. Po osiągnięciu celu przycisk „Zwerbuj” dołącza go do drużyny (jeśli jest miejsce). Rekruci zmieniają się przy każdej nowej wyprawie, więc jeśli kogoś przegapisz, pojawi się ktoś inny. W walce towarzysze poruszają się i atakują automatycznie najbliższego wroga — przeciwnicy też mogą wybrać ich jako cel zamiast Ciebie.",
