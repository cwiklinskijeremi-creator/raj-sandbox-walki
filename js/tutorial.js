...
const TUTORIAL_DATA = {
  ...
  progression: {
    ...
    paragraphs: [
      ...
      "Każde z pięciu miejsc w mieście ma swojego stałego bywalca — kliknij „💬 Zapytaj o coś”, żeby usłyszeć jedną z kilku losowych kwestii (plotki, komentarze o świecie, czasem coś więcej niż zwykła gadka). Grom z Areny i Riven Cichy Krok z Czarnego Rynku mają też własne jednorazowe zlecenie z paskiem postępu i nagrodą w surowcach — niezależne od Tablicy zadań Gildii.",
