...
const TUTORIAL_DATA = {
  ...
  camp: {
    ...
    paragraphs: [
      ...
      "Po wybraniu lokacji nie trafiasz od razu do walki — najpierw przechodzisz przez loch, komnata po komnacie, ale nie znasz z góry, co Cię czeka. Na każdym rozdrożu wybierasz kierunek na ślepo: „⬅️ Mroczniejszy korytarz” częściej prowadzi do pułapek, zasadzek i ołtarzy, „➡️ Spokojniejszy korytarz” częściej trafia na ciche zaułki i znaleziska — dopiero po wyborze odkrywasz, co naprawdę tam jest. Na ostatnim rozdrożu bywa też trzecia, tajemnicza opcja „❓ Nieznana głębia” — 20% szans, że kryje się za nią komnata bossa lokacji, którego możesz wyzwać już teraz albo wycofać się w milczeniu. W samej komnacie wybierasz między opcją bezpieczną a ryzykowną: Cichy korytarz możesz przeszukać (szansa na drobny łup, bez ryzyka) albo iść dalej. Pułapkę możesz rozbroić (łup przy sukcesie, obrażenia przy porażce) albo bezpiecznie ominąć. Znalezisko możesz zbadać dokładnie (większa nagroda, ale ryzyko pułapki) albo zabrać szybko i bezpiecznie. Zasadzkę możesz stoczyć (doświadczenie i surowiec przy zwycięstwie, obrażenia przy porażce) albo ominąć. Zapomniany ołtarz przyjmie ofiarę z Twojego zdrowia w zamian za tymczasowe wzmocnienie pancerza na nadchodzącą walkę.",
  ...
  combat: {
    ...
    paragraphs: [
      ...
      "Raz rozpoczętego starcia nie da się porzucić — przycisk „🏕️ Wróć do obozu” jest zablokowany, dopóki walka trwa, i odblokowuje się dopiero po jej zakończeniu, zwycięstwem albo porażką. Porażka też ma cenę: jeśli zginiesz, tracisz w odwrocie część zapasów zasobu zbieranego w tej lokacji.",
