...
const TUTORIAL_DATA = {
  ...
  camp: {
    ...
    paragraphs: [
      ...
      "„🗡️ Kampania” to główny wątek fabularny — Twoja osobista zemsta na zdrajcy Dorianie Vex. Pięć rozdziałów odblokowuje się jeden po drugim: pierwsze cztery to unikalne, samotne walki z bossami czterech lokacji Twojego świata (bez przechodzenia przez loch), a rozdział piąty to finałowa konfrontacja z Dorianem w Wieży Rady. Każdy rozdział ma własny wstęp i zakończenie fabularne oraz nagrodę w surowcach po zwycięstwie.",
