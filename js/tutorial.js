...
const TUTORIAL_DATA = {
  ...
  progression: {
    ...
    paragraphs: [
      ...
      "„🌟 Umiejętności” (dostępne z obozu) to drzewko talentów Twojej specjalizacji, wzorowane na Dragon Age: Origins — trzy gałęzie po cztery rangi każda. Węzły bywają bierne (stały bonus do statystyk), aktywowane (nowa zdolność bojowa z własnym odnowieniem, dochodząca do dwóch startowych czarów w menu tokenu) albo podtrzymywane (aktywowana zdolność o dłuższym działaniu i odnowieniu). Kliknij węzeł, żeby zobaczyć jego pełny opis w bocznym panelu — ranga II danej gałęzi wymaga odblokowanej rangi I w tej samej gałęzi, aż po szczytową rangę IV. „Oczyszczenie Wspomnień” w Świątyni zwraca też wydane punkty umiejętności, nie tylko statystyk.",
