...
const TUTORIAL_DATA = {
  ...
  progression: {
    ...
    paragraphs: [
      ...
      "„🌟 Umiejętności” (dostępne z obozu) to drzewko talentów Twojej specjalizacji — trzy poziomy węzłów, każdy z pasywnym bonusem do statystyk lub walki. Poziom II wymaga odblokowania obu węzłów z Poziomu I, a szczytowy węzeł Mistrzostwa wymaga odblokowania całego drzewka poniżej. „Oczyszczenie Wspomnień” w Świątyni zwraca też wydane punkty umiejętności, nie tylko statystyk.",
